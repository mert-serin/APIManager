        ...
        dispatcher.dispatch(
            ...
            onSuccess: { (responseData: Data) in
                do {
                    ...
                    jsonDecoder.dateDecodingStrategy = .formatted(DateFormatter.getDateFormatterFor(format: "yyyy-MM-dd'T'HH:mm:ss.SSS'Z"))
...
public struct URLSessionNetworkDispatcher: NetworkDispatcher {
    ...
    public func dispatch(request: RequestData, onSuccess: @escaping (Data) -> Void, onError: @escaping (Error) -> Void) {
        guard let url = URL(string: APIManagerConfiguration.shared.baseURL + request.path) else {
