...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mert-serin/APIManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mert-serin' => 'mert@eliq.io' }
  s.source           = { :git => 'https://github.com/mert-serin/APIManager.git', :tag => s.version.to_s }
